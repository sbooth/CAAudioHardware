...
extension StereoPanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<StereoPanControl>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
