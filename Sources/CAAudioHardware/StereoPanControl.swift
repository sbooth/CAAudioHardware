...
extension StereoPanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<StereoPanControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
