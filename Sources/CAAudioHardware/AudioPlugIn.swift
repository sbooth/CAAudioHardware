...
extension AudioPlugIn {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioPlugIn>, notifyOnQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
