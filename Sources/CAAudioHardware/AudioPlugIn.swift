...
extension AudioPlugIn {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioPlugIn>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
