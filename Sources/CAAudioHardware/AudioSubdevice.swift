...
extension AudioSubdevice {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioSubdevice>, inScope scope: PropertyScope = .global, onElement element: PropertyElement = .main, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
