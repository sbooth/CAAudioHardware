...
extension SliderControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<SliderControl>, perform block: PropertyChangeNotificationBlock?, on queue: DispatchQueue? = .global(qos: .background)) throws {
