...
extension SliderControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<SliderControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
