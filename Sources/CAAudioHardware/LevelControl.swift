...
extension LevelControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<LevelControl>, notifyOnQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
