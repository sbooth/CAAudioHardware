...
extension LevelControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<LevelControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
