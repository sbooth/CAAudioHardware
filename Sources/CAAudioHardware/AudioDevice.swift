...
extension AudioDevice {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioDevice>, inScope scope: PropertyScope = .global, onElement element: PropertyElement = .main, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
