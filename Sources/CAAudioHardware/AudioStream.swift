...
extension AudioStream {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioStream>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
