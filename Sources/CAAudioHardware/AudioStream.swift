...
extension AudioStream {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioStream>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
