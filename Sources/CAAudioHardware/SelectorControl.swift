...
extension SelectorControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<SelectorControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
