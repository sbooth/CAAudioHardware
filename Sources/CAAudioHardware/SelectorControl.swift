...
extension SelectorControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<SelectorControl>, perform block: PropertyChangeNotificationBlock?, on queue: DispatchQueue? = .global(qos: .background)) throws {
