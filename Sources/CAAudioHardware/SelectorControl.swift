...
extension SelectorControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<SelectorControl>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
