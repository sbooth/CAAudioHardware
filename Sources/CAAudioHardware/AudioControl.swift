...
extension AudioControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioControl>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
