...
extension AudioControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioControl>, perform block: PropertyChangeNotificationBlock?, on queue: DispatchQueue? = .global(qos: .background)) throws {
