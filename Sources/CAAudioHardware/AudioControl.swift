...
extension AudioControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
