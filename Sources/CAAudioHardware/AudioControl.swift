...
extension AudioControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioControl>, notifyOnQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
