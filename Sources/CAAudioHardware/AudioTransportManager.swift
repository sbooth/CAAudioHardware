...
extension AudioTransportManager {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioTransportManager>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
