...
extension AudioTransportManager {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioTransportManager>, notifyOnQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
