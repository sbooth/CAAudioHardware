...
extension AudioBox {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioBox>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
