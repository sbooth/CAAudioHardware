...
extension BooleanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<BooleanControl>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
