...
extension BooleanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<BooleanControl>, notifyOnQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
