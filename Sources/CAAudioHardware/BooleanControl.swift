...
extension BooleanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<BooleanControl>, onQueue queue: DispatchQueue? = nil, perform block: PropertyChangeNotificationBlock?) throws {
