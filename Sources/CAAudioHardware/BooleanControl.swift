...
extension BooleanControl {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<BooleanControl>, perform block: PropertyChangeNotificationBlock?, on queue: DispatchQueue? = .global(qos: .background)) throws {
