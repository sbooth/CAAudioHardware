...
extension AudioSystemObject {
	...
	public func whenSelectorChanges(_ selector: AudioObjectSelector<AudioSystemObject>, on queue: DispatchQueue? = .global(qos: .background), perform block: PropertyChangeNotificationBlock?) throws {
